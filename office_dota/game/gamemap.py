...
# Фонтан отодвинут за трон: в доте трон стоит ВНЕ дальности своего
# фонтана, иначе его нельзя атаковать в принципе. При прежних 495
# юнитах трон был накрыт полностью и игра не выигрывалась вообще.
DEV_FOUNTAIN = (250.0, 6950.0)
...
SPAWN_POS = {
    TEAM_DEV: (520.0, 6700.0),
    TEAM_MGMT: mirror((520.0, 6700.0)),
}
