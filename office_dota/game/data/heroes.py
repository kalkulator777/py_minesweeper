...
_EFFECT_LIST_KEYS = frozenset({"effects", "on_hit", "on_tick", "on_kill", "passives"})
    ...
    "security": {
        ...
        "abilities": [
            ...
            {   # прототип: Bounty Hunter — Jinada
                ...
                "aoe_radius": 0,
                "effects": [
                    {"op": "proc_attack", "chance": [100, 100, 100, 100], "effects": [
                        {"op": "damage", "dtype": "physical",
    ...
    "junior": {
        ...
        "abilities": [
            ...
            {   # прототип: Phantom Lancer — Phantom Rush
                ...
                "aoe_radius": 0,
                "effects": [
                    {"op": "blink", "max_dist": 700, "to": "target"},
                    {"op": "stat_buff",
...
def validate() -> bool:
    ...
    for hero_key, hero in HEROES.items():
        ...
        for ability in abilities:
            ...
            for field in ("cast_range", "cast_point", "cast_backswing", "aoe_radius"):
