...
ITEMS: dict[str, dict] = {
    ...
    "desk_drawer": {
        ...
        "desc": "В ящике стола есть всё: мгновенно 200 HP и 200 маны. "
                "Счётчик на ящике растёт от каждого вражеского заклинания рядом "
                "(до 20), но пока это только счётчик: кнопка всегда выдаёт "
                "одно и то же. Самая дешёвая кнопка «выжить» в игре.",
        "tier": 2,
    },
